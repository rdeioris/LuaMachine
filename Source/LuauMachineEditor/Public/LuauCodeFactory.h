...
#include "LuauCodeFactory.generated.h"

/**
 * 
 */
UCLASS()
class LUAUMACHINEEDITOR_API ULuauCodeFactory : public UFactory, public FReimportHandler
{
	...
	{
		return FText::FromString("Luau Code");
	}
 ...
 */
class FLuauCodeAssetTypeActions : public FAssetTypeActions_Base
{
public:
	FLuauCodeAssetTypeActions( EAssetTypeCategories::Type InAssetCategory );
