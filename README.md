...
Install the LuaMachine plugin by downloading it from the official releases page (choose the binary release for your Unreal Engine version and operating system) or from the Marketplace: 
