...
Install the LuaMachine plugin by downloading it from the official release page (choose the binary release for your Unreal Engine version and operating system): https://github.com/rdeioris/LuaMachine/releases/
