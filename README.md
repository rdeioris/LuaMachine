...
Currently only Windows 64bit and Mac are supported.

## Quickstart

In this fast (and useless example) we will print a string generated by a Lua script.

Install the LuaMachine plugin by downloading it from the official releases page (choose the binary release for your Unreal Engine version and operating system): https://github.com/rdeioris/LuaMachine/releases/

Uncompress it in the Plugins/ directory of your project (crete it if it does not exist) and restart the Unreal Editor
